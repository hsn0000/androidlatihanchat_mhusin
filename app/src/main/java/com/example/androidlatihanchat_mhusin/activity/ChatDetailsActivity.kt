package com.example.androidlatihanchat_mhusin.activity
...
import com.example.androidlatihanchat_mhusin.adapters.ChatDetailListAdapter
...
import com.example.androidlatihanchat_mhusin.data.Tools
import com.example.androidlatihanchat_mhusin.model.ChatMessage
import com.example.androidlatihanchat_mhusin.model.Friend
import com.example.androidlatihanchat_mhusin.utilities.Const
import com.example.androidlatihanchat_mhusin.utilities.Const.Companion.NODE_IS_READ
import com.example.androidlatihanchat_mhusin.utilities.Const.Companion.NODE_RECEIVER_ID
import com.example.androidlatihanchat_mhusin.utilities.Const.Companion.NODE_RECEIVER_NAME
import com.example.androidlatihanchat_mhusin.utilities.Const.Companion.NODE_RECEIVER_PHOTO
import com.example.androidlatihanchat_mhusin.utilities.Const.Companion.NODE_SENDER_ID
import com.example.androidlatihanchat_mhusin.utilities.Const.Companion.NODE_SENDER_NAME
import com.example.androidlatihanchat_mhusin.utilities.Const.Companion.NODE_SENDER_PHOTO
import com.example.androidlatihanchat_mhusin.utilities.Const.Companion.NODE_TEXT
import com.example.androidlatihanchat_mhusin.utilities.Const.Companion.NODE_TIMESTAMP
import com.example.androidlatihanchat_mhusin.utilities.CustomToast
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        valueEventListener = object : ValueEventListener {
            ...
            override fun onCancelled(databaseError: DatabaseError) {
                CustomToast(this@ChatDetailsActivity).showError(getString(com.example.androidlatihanchat_mhusin.R.string.error_could_not_connect))
            }
        }
...
//        }
    ...
    fun initToolbar() {
        val toolbar = findViewById(com.example.androidlatihanchat_mhusin.R.id.toolbar) as Toolbar
    ...
    fun iniComponen() {
        listview = findViewById(com.example.androidlatihanchat_mhusin.R.id.listview) as ListView
        btn_send = findViewById(com.example.androidlatihanchat_mhusin.R.id.btn_send) as Button
        et_content = findViewById(com.example.androidlatihanchat_mhusin.R.id.text_content) as EditText
