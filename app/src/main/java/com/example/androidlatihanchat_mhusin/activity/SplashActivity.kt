...
class SplashActivity : AppCompatActivity(), GoogleApiClient.OnConnectionFailedListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.androidlatihanchat_mhusin.R.layout.activity_splash)
        bindLogo()

        customToast = CustomToast(this)

        // Assign fields
        signInButton = findViewById(com.example.androidlatihanchat_mhusin.R.id.sign_in_button) as SignInButton
        loginProgress = findViewById(com.example.androidlatihanchat_mhusin.R.id.login_progress) as ProgressBar

        // Set click listeners
        signInButton!!.setOnClickListener(this)

        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken(getString(com.example.androidlatihanchat_mhusin.R.string.default_web_client_id))
            .requestEmail()
            .build()
...
//        }
    ...
    private fun bindLogo() {
        ...
        val splash = findViewById(com.example.androidlatihanchat_mhusin.R.id.splash) as ImageView
    ...
    override fun onClick(p0: View?) {
        when (p0!!.getId()) {
            com.example.androidlatihanchat_mhusin.R.id.sign_in_button -> signIn()
            else -> return
        }
    }
        ...
        mFirebaseAuth!!.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                ...
                if (!task.isSuccessful) {
                    customToast.showError(getString(com.example.androidlatihanchat_mhusin.R.string.error_authetication_failed))
                } else {
